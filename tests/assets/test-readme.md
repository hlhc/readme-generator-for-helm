...
| `nullableNullStringWithValueChange`                   | Nullable null string. The schema will show `nullable: true`.                                                | `nil`        |
| `nullableNullArray`                                   | Nullable null array. The schema will show the array type plus `nullable: true`.                             | `nil`        |
| `nullableNullString`                                  | Nullable null string. The string type avoids inferring an object type. The null must be preserved as value. | `nil`        |
