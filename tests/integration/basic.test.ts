...
const expectedReadmeFirstExecution = `${__dirname}/../assets/expected-readme.first-execution.md`; // File that must result from executing the tool providing a readme file with only '### Parameters' and values
const testValuesPath = `${__dirname}/../assets/test-values.yaml`; // File where the content will end after the tool is executed
const testReadmeSubsequentSectionsPath = `${__dirname}/../assets/test-readme.md`; // File where the content will end after the tool is executed
const expectedReadmeSubsequentSectionsPath = `${__dirname}/../assets/expected-readme.md`; // File that must result from executing the tool providing the test README and values
const testReadmeLastSectionPath = `${__dirname}/../assets/test-readme.last-section.md`; // File where the content will end after the tool is executed
const expectedReadmeLastSectionPath = `${__dirname}/../assets/expected-readme.last-section.md`; // File that must result from executing the tool providing the test README and values
const testReadmeLastSectionWithTextBelowPath = `${__dirname}/../assets/test-readme.last-section-text-below.md`; // File where the content will end after the tool is executed
const expectedReadmeLastSectionWithTextBelowPath = `${__dirname}/../assets/expected-readme.last-section-text-below.md`; // File that must result from executing the tool providing the test README and values
const testSchemaPath = `${__dirname}/../assets/test-schema.json`; // File where the content will end after the tool is executed
const expectedSchemaPath = `${__dirname}/../assets/expected-schema.json`; // File that must result from executing the tool providing the test README and values
const testReadConfigFile = `${__dirname}/../assets/test-readme.config.md`; // Configuration file
const testConfigFile = `${__dirname}/../assets/test-config.json`; // Configuration file
const expectedReadmeConfig = `${__dirname}/../assets/expected-readme.config.md`; // File where the content will end after the tool is executed
const testValuesSubsectionPath = `${__dirname}/../assets/test-values.subsection.yaml`; // Values with subsection metadata
const expectedReadmeSubsectionPath = `${__dirname}/../assets/expected-readme.subsection.md`; // Expected README when subsection metadata is rendered
